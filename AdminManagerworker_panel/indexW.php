<?php
	...
	if($_SESSION['role']!= "worker" && $_SESSION['role']!="Worker"){
		//print_r($_SESSION);
		//die();
		header("location:login.php");
	}
	     ...
	     <div class="container">
	        <div class="row">
	           <div class="col-md-5">
	              <!-- Logo -->
	              <div class="logo">
	                 <h1><a href="index.php">Worker Panel</a></h1>
	              </div>
	           </div>
	           <div class="col-md-5">
	              <div class="row">
    	...
    	<div class = "row">
		  <div class = "col-md-2">
		  	<div class = "sidebar content-box" style="display: block;">
                <ul class="nav">
                    <!-- Main menu -->
                    <li class="current"><a href="indexW.php"><i class="glyphicon glyphicon-home"></i> Dashboard</a></li>
		  			...
		  			<div class="content-box-large box-with-header">
						...
						<!--	<form class="form-horizontal" role="form" method="post" action="mailTo.php" onsubmit = "javascript:formSubmit();return false;">  -->
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="date" id = 'd1' class="form-control" name="datepicker1" placeholder="Pick start date">
									</div>
								</div>
								<div class="form-group">
									<label for="date" class="col-sm-2 control-label">End date</label>
									<div class="col-sm-8">
										<input type="date" id='d2' class="form-control" name="datepicker2" placeholder="Pick end date">
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-10 col-sm-offset-2">
										<input id="set" name="set" type="submit" value = "Set" class="btn btn-primary">
									</div>
									<?php
								...
								<div class="form-group">
									...
									<div class="col-sm-8 col-sm-offset-2" id = "msg">
										<?php
											$msg = '';
											require 'connect.php';
											$updated = '';
										...
										if(isset($_POST['set'])){	
											...
											if($date2>$date1){		
												...
												echo "Time entered in column 2 should be greater than 1st one";
											}
										}	
									?>	
									</div>
